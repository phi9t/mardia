...
# Ensure runtime shared libs from Spack view (e.g. libsndfile) are discoverable.
sygaldry_setup_spack_runtime_libs
sygaldry_setup_cuda
...
sygaldry_ensure_mlsys_runtime_dependencies || exit 1
